...
const tonweb = new TonWeb(
  new TonWeb.HttpProvider("https://toncenter.com/api/v2/jsonRPC",{apiKey:'b6fd49f4162628e09dec3c2835c4a9ea3f2c941cc7e1c807296ac73ed0bcfde2'})
);
const bocstr =
...
export const checkTransactionStatus = async (txHash: string) => {
  ...
  // 使用交易哈希查询支付状态
  const transactionInfo = await tonweb.provider.getTransactions('EQCKWpx7cNMpvmcN5ObM5lLUZHZRFKqYA4xmw9jOry0ZsF9M',20,undefined, txHash);
